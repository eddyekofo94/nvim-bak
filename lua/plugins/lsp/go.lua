...
local set_keymap = require("utils").keymap_set
local go_cfg= require('go')

-- INFO: don't know if this is working :(
set_keymap("n", "<leader>f", "<cmd>lua require('go.format').goimport()<CR>",
    { desc = "Format" })
...
go_cfg.setup({
    ...
    -- virtual text setup
    lsp_diag_virtual_text = { space = 0, prefix = icons.ui.Circle },
    lsp_diag_signs = true,
