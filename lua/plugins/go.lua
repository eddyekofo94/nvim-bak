    ...
    config = function()
        ...
        require("go").setup({
            ...
            lsp_on_attach = function(client, bufnr)
                ...
                keymap_set("n", "<leader>f", "<cmd>lua require('go.format').goimport()<CR>", {desc = "Format"})
            ...
            lsp_diag_virtual_text = { space = 0, prefix = icons.arrows.DoubleArrowRight }, -- virtual text setup
            lsp_diag_signs = true,
